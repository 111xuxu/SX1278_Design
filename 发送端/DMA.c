...
DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)&(USART1->DR); // 外设地址：USART1->DR
DMA_InitStructure.DMA_MemoryBaseAddr    = (uint32_t)temp;      // 内存地址：自定义缓冲区
